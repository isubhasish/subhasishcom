...
async def incoming_cancel_message_f(bot, update):
  """/cancel command"""
  #if update.from_user.id != 1051485224 or 1080613661:
  ...
  if os.path.exists(status):
    ...
    await update.reply_text("<b>Are You Sure? 🚫 This Will Stop The Current Compression..!!🙁</b>", reply_markup=reply_markup, quote=True)
  else:
   # delete_downloads()
    await bot.send_message(
      chat_id=update.chat.id,
