...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    with open(progress, 'w') as f:
      pass
    ##  -metadata title='Subhasish-Encodes [Contact t.me/Subhasish_bot]' -vf drawtext=fontfile=Italic.ttf:fontsize=20:fontcolor=black:x=15:y=15:text='Subhasish Encodes'
    ##"-metadata", "title=@idsubhasish", "-vf", "drawtext=fontfile=njnaruto.ttf:fontsize=20:fontcolor=black:x=15:y=15:text=" "Subhasish Encodes",
 ...
 #Done !!
    ...
    while process.returncode != 0:
      ...
      with open(DOWNLOAD_LOCATION + "/progress.txt", 'r+') as file:
        ...
        stats = f'ℹ️ <b>ɴᴏᴡ:</b> <b>💡 ENCODING... 💡</b>\n\n' \
                f'⏱️ <b>ᴇᴛᴀ:</b> {ETA}\n\n' \
                f'{progress_str}\n'
        try:
...
async def take_screen_shot(video_file, output_directory, ttl):
    ...
    if os.path.lexists(out_put_file_name):
        ...
        return None
# Bruh I edited this,  maybe if it is wrong correct it